...
const Contact = () => {
    return (
        <section className='contact section' id='contact'>
            ...
            <span className='section_subtitle'>Want to collaborate or offer a chance to work with your team?</span>
                ...
                <div className='contact_content'>
                    ...
                    <div className='contact info'>
                        <div className='contact_card'>
                            ...
                            <span className='contact_card-data'>jenny@blacutt.com</span>

                            {/* <a href='mailto:jenny@blacutt.com' className='contact_button'>Write me <i className='bx bx-right-arrow-alt contact_button-icon'></i></a> */}
                        </div>
                        ...
                        <div className='contact_card'>
                            ...
                            <span className='contact_card-data'>213-284-4878</span>
...
/* TODO research npm install emailjs */